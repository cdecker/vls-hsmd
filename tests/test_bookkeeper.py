...
@unittest.skipIf(os.getenv("VLS_MODE") != "cln:native", "hsmd_sign_option_will_fund_offer not supported")
...
@unittest.skipIf(os.getenv('TEST_DB_PROVIDER', 'sqlite3') != 'sqlite3', "turns off bookkeeper at start")
@unittest.skipIf(TEST_NETWORK != 'regtest', "network fees hardcoded")
@unittest.skipIf(os.getenv("VLS_MODE") != "cln:native" and os.getenv('VLS_PERMISSIVE') != '1', "remote_hsmd doesn't allow push of non-trivial amount")
...
@unittest.skipIf(os.getenv('VLS_MODE') != "cln:native", "Message hsmd_sign_bolt12_2 is not handled correctly by VLS.")
