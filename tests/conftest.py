# tests/conftest.py
# This file is needed for pytest to properly handle imports in the tests directory.
# It allows `from fixtures import *` to work by making tests/ part of the import context.
