...
@unittest.skipIf(os.getenv("VLS_MODE") != "cln:native", "already have a different invoice for same secret")
...
@unittest.skipIf(os.getenv("VLS_MODE") != "cln:native", "no such channel")
