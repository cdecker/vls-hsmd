...
@unittest.skipIf(os.getenv('VLS_MODE') != 'cln:native' and os.getenv('VLS_PERMISSIVE') != '1', "feerate above maximum: 880782 > 151000")
...
@unittest.skipIf(os.getenv("VLS_MODE") != "cln:native", "fails multiple policy checks")
...
@pytest.mark.parametrize("anchors", [False, True])
@unittest.skipIf(os.getenv("VLS_MODE") != "cln:native" and os.getenv('VLS_PERMISSIVE') != '1', "invoice with any amount")
...
@unittest.skipIf(os.getenv("VLS_MODE") != "cln:native" and os.getenv('VLS_PERMISSIVE') != '1', "feerate above maximum (escalates)")
...
@unittest.skipIf(not VLS_MODE_NATIVE, "inv_nosecret: The invoice is missing the mandatory payment secret")
...
@unittest.skipIf(not VLS_MODE_NATIVE, "Broken plugin path")
...
@pytest.mark.slow_test
@unittest.skipIf(os.getenv("VLS_MODE") != "cln:native" and os.getenv('VLS_PERMISSIVE') != '1', "remote_hsmd doesn't allow push of greater than 20k sat")
...
@unittest.skipIf(not VLS_MODE_NATIVE, "hsm_sign_b12 fails with TrailingBytes(93, 41)")
...
@unittest.skipIf(not VLS_MODE_NATIVE, "invoice not bolt12: InvalidSemantics(UnsupportedCurrency) and not bolt11: Bech32Error(InvalidChecksum)")
...
@unittest.skipIf(os.getenv("VLS_MODE") != "cln:native", "invoice not bolt12: Decode(UnknownRequiredFeature) and not bolt11: Bech32Error(InvalidChecksum)")
...
@unittest.skipIf(os.getenv("VLS_MODE") != "cln:native" and os.getenv('VLS_PERMISSIVE') != '1', "tried commitment when funding is not buried ")
