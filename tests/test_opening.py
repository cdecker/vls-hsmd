...
@unittest.skipIf(os.getenv("VLS_MODE") != "cln:native", "sign_option_will_fund_offer unimplemented")
@pytest.mark.openchannel('v2')
...
@unittest.skipIf(os.getenv("VLS_MODE") != "cln:native" and os.getenv('VLS_PERMISSIVE') != '1', "ensure_funding_buried_and_unspent: tried commitment 1 when funding is not buried at depth 0")
...
@unittest.skipIf(os.getenv("VLS_MODE") != "cln:native", "missing WIRE_HSMD_CUPDATE_SIG_REQ log messages")
