...
@pytest.mark.openchannel('v1')
@pytest.mark.openchannel('v2')
@unittest.skipIf(os.getenv('VLS_MODE') != "cln:native", "l1 does not restart correctly after stop.")
...
@unittest.skipIf(os.getenv("VLS_MODE") != "cln:native" and os.getenv('VLS_PERMISSIVE') != '1', "validate_setup_channel: holder_shutdown_script is not in wallet or allowlist")
@pytest.mark.openchannel('v1')
@pytest.mark.openchannel('v2')
...
@unittest.skipIf(os.getenv("VLS_MODE") != "cln:native", "flakes too frequently w/ VLS")
...
@pytest.mark.openchannel('v1')
@pytest.mark.openchannel('v2')
@unittest.skipIf(not VLS_MODE_NATIVE, "Some vlsd2 proc startup issues, causing stop to fail")
...
@unittest.skipIf(os.getenv("VLS_MODE") != "cln:native", "Legacy channel type not supported")
...
@unittest.skipIf(os.getenv("VLS_MODE") != "cln:native", "No module named 'websockets'")
...
@unittest.skipIf(not VLS_MODE_NATIVE, "hsmd_sign_bolt2_2 fails with TrailingBytes(93, 41)")
