...
@unittest.skipIf(os.getenv("VLS_MODE") != "cln:native" and os.getenv('VLS_PERMISSIVE') != '1', "non-beneficial value considered as fees is above maximum feerate")
...
@unittest.skipIf(os.getenv('VLS_MODE') != "cln:native", "remote_hsmd doesn't support hsm_secret file")
...
@unittest.skipIf(os.getenv("VLS_MODE") != "cln:native", "remote_hsmd doesn't support generatehsm")
