...
from utils import (
    ...
    sync_blockheight, wait_for, TEST_NETWORK, TIMEOUT, VLS_MODE_NATIVE
)
import os
import pytest
import subprocess
...
@unittest.skipIf(not VLS_MODE_NATIVE, "Timing out.")
...
@pytest.mark.slow_test
@unittest.skipIf(not VLS_MODE_NATIVE, "Times out with external signer")
...
@pytest.mark.slow_test
@unittest.skipIf(os.getenv("VLS_MODE") != "cln:native", "Signer state is missing for the node in question.")
